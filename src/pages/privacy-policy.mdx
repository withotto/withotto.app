...
Otto Capture connects to accounting platforms such as Xero and FreeAgent so it can match contacts and code, validate, and publish documents on your behalf.
...
If you disconnect a platform, the data we have already synced is retained unless you ask us to delete it. You can request deletion at any time, and we will delete platform-sourced data that is no longer required.
