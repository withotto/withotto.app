...
<div class="mx-auto mt-8 max-w-3xl rounded-lg border-l-4 border-success bg-success-soft p-6">
    <h3 class="mb-3 text-xl font-semibold text-deep-sea">Getting Started with Bank Rules</h3>
    <p class="mb-4">Otto works best when you have bank rules set up in Xero. Our quick guide will show you how bank
        rules can:</p>
    <ul class="list-disc space-y-2 pl-5 mb-4">
        <li>Save you significant time on reconciliation</li>
        <li>Reduce errors and improve consistency</li>
        <li>Help Otto do more automated work for you</li>
    </ul>
    <a href="/files/Bank%20rules%20quick%20guide.pdf"
       class="inline-flex items-center font-medium text-persian hover:text-deep-sea">
        Download the guide →
    </a>
</div>
