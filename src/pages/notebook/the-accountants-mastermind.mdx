...
title: With Otto for The Accountants' Mastermind Members
...
- **Practical Demonstration**: See Otto's portal in action, understanding how to monitor automated reconciliations, and how you can configure Otto to work for your practice and clients
...
- **Realistic Expectations**: We'll be honest about what Otto can and cannot do, ensuring you know what to expect from Otto
...
<div class="mx-auto max-w-3xl">
    <div class="relative flex items-start rounded-md border border-primary/20 bg-primary-soft p-4 shadow-sm">
        <div class="ml-4">
            <p class="!mt-0 mb-4 font-medium text-primary-strong">Partnership Transparency</p>
            <p class="mb-4 text-default">The Accountants' Mastermind is a With Otto affiliate partner. This
                means:</p>
            <ul class="mb-4 list-disc pl-6 text-default">
                <li class="mb-2">They earn a commission for each subscriber they refer to us</li>
                <li class="mb-2">If you subscribe, we'll share your name, email address, and chosen plan with them</li>
                <li class="mb-2">No information is shared during your trial period unless you become a subscriber</li>
            </ul>
            <p class="text-default !mb-0">This partnership helps support The Accountants' Mastermind whilst connecting
                you with Otto's reconciliation expertise.</p>
        </div>
    </div>
</div>
