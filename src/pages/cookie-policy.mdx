...
The live chat on our website is one example, though not a third-party one. We use Chatwoot, which we host ourselves at chat.withotto.app, so your conversation is not passed to a chat provider. When the chat widget loads, it sets one cookie on this site, cw_conversation, to keep your chat session and conversation history working across visits.
